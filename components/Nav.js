        ...
        <div className="flex lg:flex-row md:flex-row flex-col  items-center justify-between text-blue-gray-900">
          ...
          <div className="hidden items-center  lg:flex space-x-4">
            ...
            <ul className="flex gap-2">
              <li><img src="/social-icon/twitter.svg" className="size-8"/></li>
              <li><img src="/social-icon/youtube.svg" className="size-8"/></li>
              <li><img src="/social-icon/inst.svg" className="size-8"/></li>
              <li><img src="/social-icon/fb.svg" className="size-8"/></li>
            </ul>
          </div>
        </div>
      </nav>
